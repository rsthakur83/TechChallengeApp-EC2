# TechChallengeApp Deployment on AWS EC2 Instance
...
- #### **terraform_backend**
     ...
     In the first stage of pipeline, it create two S3 bucket (one to store terraform statefile and other to store the artifact) as per the environmental variable `app_artifact_bucket` and `terraform_state_bucket`.
